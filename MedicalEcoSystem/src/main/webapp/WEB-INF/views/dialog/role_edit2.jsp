					...
					<table class="not_hightlight">
						...
						<tr>
							...
							<td>
								<div class="J_toolsBar fl">
									<div class="t_text w200 ml10">
										<label> <input type="text" name="realName"
											data-rule="真实姓名:length[~20];" value="${user.realName }" />
										</label>
									</div>
								</div>
							</td>
								...
								<div class="J_toolsBar fl">
									<div class="t_text w200 ml10">
										<label> <input type="text" name="mobile"
											data-rule="手机号码:mobile;" value="${user.mobile }" />
										</label>
									</div>
								</div>
							</td>
							...
							<td>
								<div class="J_toolsBar fl">
									<div class="t_label ml10" style="width: 220px;">
										<select data-placeholder="选择权限" multiple class="chosen-select"
											name="roleId" data-rule="权限:required;">
